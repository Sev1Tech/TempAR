...
{
    public string temperatureURL = "http://54.234.173.6:8181/sensorhub/ngfrsos?service=SOS&version=2.0&request=GetResult&offering=urn:osh:sensor:sensehat:2b4693cf-sos&observedProperty=http://sensorml.com/ont/swe/property/AirTemperature&temporalFilter=phenomenonTime,now&responseFormat=application/json";
    ...
    void Update()
    {
        ...
        else
        {
            ...
            GetComponent<TextMesh>().text = "T: " + temperature.ToString("0.00");
